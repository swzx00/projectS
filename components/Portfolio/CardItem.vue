...
<template>
  <div
    class="group z-0 flex w-full max-w-full flex-col flex-nowrap items-start justify-start overflow-hidden rounded-md transition-all duration-300 ease-linear first:*:rounded-b-md first:*:rounded-t-md last:*:rounded-b-md"
  >
    <NuxtLink
