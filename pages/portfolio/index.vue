...
<template>
  ...
  >
    ...
    >
      ...
      <div
        class="* mx-auto mb-8 flex w-full max-w-full flex-col flex-wrap items-center justify-start gap-y-2 px-4 xs:flex-row xs:gap-x-4 md:max-w-[960px] md:gap-y-0 lg:max-w-[960px] xl:max-w-[1024px] 2xl:max-w-[1280px]"
      >
